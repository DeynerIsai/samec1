...
include_once '../Plugins/Core/Model.php';
include_once '../Plugins/Model/Log.php';
/*include_once 'Exception';
include_once 'PDOException';*/
...
class User
{
    ...
    {
        $sql = "SELECT id_usuario, nombre, apellidos, usuario, pass, tipo, correo, telefono, direccion, genero FROM usuarios where estado=1";
     ...
     */
    public function getAllUsersByStatus($estado)
    {

        $sql        = "SELECT id_usuario, nombre, apellidos, usuario, pass, tipo, correo, telefono, direccion, genero FROM usuarios where estado=1";
        $parameters = array(':estado' => $estado);
