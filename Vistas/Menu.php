            ...
            <div class="full-box dashboard-sideBar-ct">
                ...
                <div class="full-box dashboard-sideBar-UserInfo">
                    <figure class="full-box">
                        <img alt="UserIcon" src="perfiles/vato.jpg">
                ...
                <ul class="list-unstyled full-box dashboard-sideBar-Menu">
                    ...
                    <li>
                        ...
                        <ul class="list-unstyled full-box">
                            <li>
                                <a  data-toggle="modal" href="?cargar=Ventas"  class="nav-link">
                                <i class="zmdi zmdi-book zmdi-hc-fw"></i>
                                Nuevo servicio
                                </a>
                            </li>
                            <li>
                                <a  data-toggle="modal" href="?cargar=AdministrativaListarEquipo"  class="nav-link">
                                <i class="zmdi zmdi-book zmdi-hc-fw"></i>
                    ...
                    <li>
                        ...
                        <ul class="list-unstyled full-box" >
                            ...
                            <li>
                                <a href="?cargar=AdministrativaListarUsuario&tipo=Soporte">
                    ...
                    <li>
                        ...
                        <ul class="list-unstyled full-box" >
                            ...
                            <li>
                                <a href="?cargar=AdministrativaListarUsuario&tipo=Normal">
                                    <i class="zmdi zmdi-male-female zmdi-hc-fw">
                                    </i>
                                    PDF-Servicios
                                </a>
